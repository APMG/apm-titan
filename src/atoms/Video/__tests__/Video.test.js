...
describe('Video', () => {
  ...
  test('Renders video object for facebook.com', () => {
    ...
    expect(container.innerHTML).toBe(
      '<div class="content_primaryVisual"><figure class="figure"><iframe title="credit name" src="https://www.facebook.com/plugins/video.php?href=https://www.facebook.com/MPRnews/videos/337942824530987&amp;show_text=0&amp;width=560" scrolling="no" frameborder="0" allowtransparency="true" allowfullscreen=""></iframe><figcaption class="figure_caption"><div class="figure_caption_content">this is a video caption for facebook</div><a href="https://www.facebook.com" target="_blank" rel="noreferrer"><span class="figure_credit">credit name</span></a></figcaption></figure></div>'
    );
    expect(container.getElementsByClassName('figure_caption')).toHaveLength(1);
    expect(
      container.getElementsByClassName('figure_caption_content')
  ...
  test('Renders video object for youtube.com', () => {
    ...
    expect(container.innerHTML).toBe(
      '<div class="content_primaryVisual"><figure class="figure"><iframe title="credit name" src="https://www.youtube.com/embed/JrAPSy9Rboc"></iframe><figcaption class="figure_caption"><div class="figure_caption_content">this is a video caption for youtube</div><a href="https://www.youtube.com" target="_blank" rel="noreferrer"><span class="figure_credit">credit name</span></a></figcaption></figure></div>'
    );
    expect(container.getElementsByClassName('figure_caption')).toHaveLength(1);
    expect(
      container.getElementsByClassName('figure_caption_content')
