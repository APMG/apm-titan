...
function getVideoPlayer(video) {
    ...
    switch(uri.hostname) {
      case 'www.facebook.com':
        ...
        playerEmbed = <iframe src={video.url} width="560" height="460" scrolling="no" frameBorder="0" allowtransparency="true" allowFullScreen={true}></iframe>
        break;
      ...
      case 'www.youtube.com':
        // eslint-disable-next-line jsx-a11y/iframe-has-title
        playerEmbed = <iframe src={video.url.replace(/watch\?v=/g, 'embed/')} width="420" height="460"></iframe>
        break;
      default:
